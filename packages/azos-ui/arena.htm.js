...
export function renderMain(app, self){
  ...
  <div class="applet-container" role="main">
    ...
    <p>
    The RD-170 (Russian: РД-170, Ракетный Двигатель-170, tr. Raketnyy Dvigatel-170) is the world's most powerful and heaviest liquid-fuel
    rocket engine. It was designed and produced in the Soviet Union by NPO Energomash for use with the Energia launch vehicle. The engine
    burns kerosene fuel and LOX oxidizer in four combustion chambers, all supplied by one single-shaft, single-turbine turbopump rated at
     170 MW (230,000 hp) in a staged combustion cycle.
     </p>
     <p>
     The RD-180 uses only two combustion chambers instead of the four of the RD-170. The RD-180 used on the Atlas V replaced the three engines
     used on early Atlas rockets with a single engine and achieved significant payload and performance gains. This engine had also been chosen
      to be the main propulsion system for the first stage of the now cancelled Russian Rus-M rocket.
     </p>
  </div>
  `;
}
