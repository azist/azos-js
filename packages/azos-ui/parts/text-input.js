...
export class TextInput extends AzosPart{
  ...
  render(){
    ...
    let compArea='';
    this.isTextArea ? compArea = html`<textarea id="${this.id}" class="${clsRank} ${clsStatusBg}" minLength="${this.minLength ? this.minLength : ''}" maxLength="${this.maxLength ? this.maxLength : ''}" placeholder="${this.placeholder}" rows="${this.height ? this.height : "4"}" value="${this.value}" .disabled=${this.isDisabled}></textarea>`
    : this.isPassword ? compArea = html`<input type="password" id="${this.id}" class="${clsRank} ${clsStatusBg}" minLength="${this.minLength ? this.minLength : ''}" maxLength="${this.maxLength ? this.maxLength : ''}" placeholder="${this.placeholder}" value="${this.value}" .disabled=${this.isDisabled}>`
    : this.isInputText ? compArea = html`<input type="text" id="${this.id}" class="${clsRank} ${clsStatusBg}" minLength="${this.minLength ? this.minLength : ''}" maxLength="${this.maxLength ? this.maxLength : ''}" placeholder="${this.placeholder}" value="${this.value}" .disabled=${this.isDisabled}>`
