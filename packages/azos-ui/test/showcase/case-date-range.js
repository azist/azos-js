...
#drHasValue{ width: calc(50% - 20px);}
  ...
  #tbChange() {
    this.drProgrammatic.setValueFromInput({ start: this.tbStart.value, end: this.tbEnd.value });
  ...
  renderControl() {
    return html`
      ...
      <az-text id="tbStart" scope="this" @change="${() => this.#tbChange()}" title="Start" dataKind="date" value="${this.#dateRangeStartValue.start}"></az-text>
      <az-text id="tbEnd" scope="this" @change="${() => this.#tbChange()}" title="End" dataKind="date" value="${this.#dateRangeStartValue.end}"></az-text>
      ...
      <h2>Date Range</h2>
      <az-date-range title="Valid Span UTC opt: sta, end" optionalStart optionalEnd></az-date-range>
      <az-date-range title="Valid Span UTC opt: sta" optionalStart></az-date-range>
      <az-date-range title="Valid Span UTC opt: end" optionalEnd></az-date-range>
