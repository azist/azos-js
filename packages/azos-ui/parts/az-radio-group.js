...
export class AzRadioGroup extends AzosElement{
    ...
    constructor(){
        ...
        if(this.getAttribute('type')){
            this.getAttribute('type')=='switch' ? this.customCheck='switch' :
            this.getAttribute('type')=='check' ? this.customCheck='customCheck' :
            this.customCheck='radio';
        }else{this.customCheck='radio';}
        !this.getAttribute('color')||this.getAttribute('color')=='' ? this.colorChoice='text_dark' : this.colorChoice=this.getAttribute('color');
        this.icon='';
        this.addPadding='';
        if(this.colorChoice.includes('bg_')||this.colorChoice.includes('border_')) this.addPadding='addPadding';
    ...
    render(){
        return html`
            <div class="${this.colorChoice} ${this.addPadding}">
