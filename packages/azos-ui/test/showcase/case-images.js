...
<div class="case-images">
  ...
  <div class="examples jpg">
    ${this.renderFigure("jpg://test.ico.testJpg", { wrapImage: false })}
    ...
    ${this.renderFigure("jpg://test.ico.testDataJpg", { wrapImage: false })}
  ...
  <div class="examples png">
    ${this.renderFigure("png://test.ico.testPng", { wrapImage: false })}
    ${this.renderFigure("@https://upload.wikimedia.org/wikipedia/commons/2/21/Nhonlam.png", { wrapImage: false })}
    ${this.renderFigure("png://test.ico.testDataPng", { wrapImage: false })}
  ...
  <div class="examples gif">
    ${this.renderFigure("gif://test.ico.testGif", { wrapImage: false })}
    ${this.renderFigure("@https://upload.wikimedia.org/wikipedia/commons/c/c8/132C_trans.gif", { wrapImage: false })}
    ${this.renderFigure("gif://test.ico.testDataGif", { wrapImage: false })}
  ...
  <div class="examples svg">
    ${this.renderFigure("svg://test.ico.testSvg", { wrapImage: false })}
    ...
    ${this.renderFigure("svg://test.ico.testDataSvg", { wrapImage: false })}
    ${this.renderFigure("svg://test.ico.testSvgUrl", { wrapImage: false })}
  ...
  <div class="examples">
    ...
    ${this.renderFigure("No Image Registry", null, null, renderImageSpec(null, "jpg://test.ico.testJpg"))}
  </div>
</div>
    `;
  }
